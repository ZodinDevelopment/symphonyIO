...
class User(UserMixin, db.Model):
    ...
    videos = db.relationship('Video', backref='artist', lazy='dynamic')
    ...
    def avatar(self, size):
        ...
        return "https://www.gravatar.com/avatar/{}?d=identicon&s={}".format(digest, str(size))
...
class Post(db.Model):
    ...
    def __repr__(self):
        return "<Post from '{}' on '{}'>".format(str(self.user_id), str(self.timestamp))
